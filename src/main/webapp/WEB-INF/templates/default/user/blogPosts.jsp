...
<custom:generic_2col>
    ...
    <jsp:attribute name="title">
        ${blog.name} <spring:message code="blogPosts.page.htmlTitle"/>
    </jsp:attribute>

    <jsp:attribute name="header">
        <c:set var="topMenu" value="post" scope="request"/>
    ...
    <jsp:body>
        <%--page header--%>
        <%@ include file="inc/blogHeaderPage.jsp" %>
        <c:set var="blogMenu" value="posts" scope="request"/>
        <%@ include file="inc/blogMenu.jsp" %>
