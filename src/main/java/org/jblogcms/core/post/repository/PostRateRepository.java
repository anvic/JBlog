...
/**
 * Provides the persistence service for accessing, adding, changing, deleting {@link PostRate}.
 *
 * @author Victor Andreenko
 */
@Repository
public interface PostRateRepository
        extends ItemRateRepository<Post, PostRate> {
}
