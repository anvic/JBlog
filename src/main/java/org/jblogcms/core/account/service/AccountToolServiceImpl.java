 ...
 */
@Service
public class AccountToolServiceImpl
        extends ItemServiceToolImpl<Account, AccountRelation, AccountRate>
        implements AccountToolService {

    public AccountToolServiceImpl() {
    }
}
