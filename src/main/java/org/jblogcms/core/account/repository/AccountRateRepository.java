...
/**
 * Provides the persistence service for accessing, adding, changing, deleting {@link AccountRate}.
 *
 * @author Victor Andreenko
 */
@Repository
public interface AccountRateRepository
        extends ItemRateRepository<Account, AccountRate> {
}
