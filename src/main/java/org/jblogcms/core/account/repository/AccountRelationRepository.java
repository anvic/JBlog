...
/**
 * Provides the persistence service for accessing, adding, changing, deleting {@link AccountRelation}.
 *
 * @author Victor Andreenko
 */
@Repository
public interface AccountRelationRepository
        extends ItemRelationRepository<Account, AccountRelation> {
