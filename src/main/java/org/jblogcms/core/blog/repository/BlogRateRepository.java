...
/**
 * Provides the persistence service for accessing, adding, changing, deleting {@link BlogRate}.
 *
 * @author Victor Andreenko
 */
@Repository
public interface BlogRateRepository
        extends ItemRateRepository<Blog, BlogRate> {
}
